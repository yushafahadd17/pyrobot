...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/c394b9d3247403031589d.png",
...
async def peler_function(message: Message, answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            title="alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph//file/4ee0d0108ebac618a59f1.jpg",
            input_message_content=InputTextMessageContent(
                msg, parse_mode=ParseMode.HTML, disable_web_page_preview=True
            ),
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ", url="t.me/yushaa17"), InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="t.me/yushafahadd")], [InlineKeyboardButton(text="ᴍᴇɴᴜ", callback_data="reopen")]]
            ),
        )
    )
    return answers
